...
public class Covoiturage {
    ...
    public String toString() {
        return "Covoiturage{" + "id_covoiturage=" + id_covoiturage + ", adresse_depart=" + adresse_depart + ", adresse_arrive=" + adresse_arrive + ", date_depart=" + date_depart + ", heure_depart=" + heure_depart + ", nb_place=" + nb_place + ", prix=" + prix + ", description=" + description + '}';
    }
